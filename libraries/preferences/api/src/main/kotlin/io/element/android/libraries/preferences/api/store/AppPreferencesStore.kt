...
interface AppPreferencesStore {
    ...
    /**
     * @param value whether media is fetched automatically only while on wifi.
     */
    suspend fun setMediaAutoDownloadOnWifiOnly(value: Boolean)

    /** Whether automatic media download is restricted to wifi; defaults to false. */
    ...
    /**
     * @param value in which rooms a link should be expanded into a preview.
     */
