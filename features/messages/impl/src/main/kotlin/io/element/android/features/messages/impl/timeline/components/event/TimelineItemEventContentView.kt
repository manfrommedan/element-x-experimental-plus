...
fun TimelineItemEventContentView(
    ...
    // Our own media is never hidden behind the protection curtain, so callers rendering
    // an outgoing bubble pass this through instead of blurring what the user just sent.
    ...
    val hideMediaContent = remember(eventId, isMine, timelineProtectionState.protectionState) {
        timelineProtectionState.hideMediaContent(eventId, isMine)
    }
    val showUrlPreviews = timelineProtectionState.showUrlPreviews
