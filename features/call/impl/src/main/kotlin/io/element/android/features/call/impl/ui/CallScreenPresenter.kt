...
class CallScreenPresenter(
    ...
    private val isAudioOnlyCall = (callType as? CallType.RoomCall)?.isAudioCall == true
    ...
    override fun present(): CallScreenState {
        ...
        // or threaded through CallType.notifyEventId (recipient via incoming notification).
        var notifyEventId by rememberSaveable {
            mutableStateOf((callType as? CallType.RoomCall)?.notifyEventId)
        }
